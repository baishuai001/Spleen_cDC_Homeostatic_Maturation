...
if (analysis_mode == "integrated") {
  subset_cache_file <- file.path(v3_robjects_dir, "integrated_01_subset_extracted.rds")
} else {
  subset_cache_file <- file.path(v3_robjects_dir, paste0(analysis_mode, "_01_subset_extracted.rds"))
}
