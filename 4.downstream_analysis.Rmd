...
cluster_stats <- data.frame(
  RNA_Cluster = names(table(seurat_obj$SCT_clusters)),
  RNA_Cell_Count = as.vector(table(seurat_obj$SCT_clusters)),
  ADT_Cluster = names(table(seurat_obj$ADT_clusters)),
  ADT_Cell_Count = as.vector(table(seurat_obj$ADT_clusters))
)

write.xlsx(cluster_stats,
